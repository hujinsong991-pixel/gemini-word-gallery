    ...
    >
      {isPlaying ? (
        <div className="w-4 h-4 flex items-center gap-0.5">
          <div className="w-0.5 bg-stone-900 dark:bg-stone-300 animate-[bounce_0.6s_infinite]"></div>
          <div className="w-0.5 bg-stone-900 dark:bg-stone-300 animate-[bounce_0.6s_infinite_0.1s]"></div>
          <div className="w-0.5 bg-stone-900 dark:bg-stone-300 animate-[bounce_0.6s_infinite_0.2s]"></div>
        </div>
      ) : (
        <svg className="w-4 h-4 text-stone-300 dark:text-stone-700 group-hover:text-stone-900 dark:group-hover:text-stone-300 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
